...
You can change the configs directly into the files `config/test_reproduce.json` and `config/test_segment.json` to change the time slice, the target language of the size of the collected data, etc.
